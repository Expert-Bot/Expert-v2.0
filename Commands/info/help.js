...
module.exports = {
  ...
  const devbutton = new ButtonBuilder()
    ...
    .setTitle("<:1072automod:1117884077387825294> Multifunctional Discord bot")
      .setDescription(" <:RexZ_module_on:850022735080980525> Bot is works only with Slash Commands <:icon_slash:1106284500826193930> ```See lists of commands by selecting a category down below!```")
   	  .addFields({ name: ' <:4928applicationbot:1117884195969179778> ➜ If you need any help just Contact developer support', value: `Report this with \`/report bug\`` })
    .addFields({ name: ' <:4928applicationbot:1117884195969179778> ➜ Make sure Expert has the highest role, its required to secure your server at the highest quality.', value: `You can now play games on Expert bot. Use \`/games-multiplayer\` to explore this new feature now! ` })
      .setColor("#ae2e83")
      .setImage(`https://media.discordapp.net/attachments/1101154380381692055/1112463464301080748/Brown_lofi_2.png?width=1259&height=249`)
